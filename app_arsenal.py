...
def run_arsenal_app() :
    ...
    img_url = 'https://images.alphacoders.com/970/thumb-1920-970085.jpg'
    st.image(img_url)
    img_url = 'https://theanalyst.com/wp-content/uploads/2022/09/arsenal-looking-like-the-real-deal.jpg'
    st.image(img_url)
    ...
    # 아스날 선수
    players = st.radio(
    "21 - 22 시즌 아스날 상위권 선수들",
    ('수비수', '미드필더', '공격수'))
    
    stats_manutd = df2[df2['Team'] == 'Arsenal']
